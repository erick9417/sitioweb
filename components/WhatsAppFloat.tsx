...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="hidden lg:flex fixed bottom-5 right-5 z-50 items-center gap-3 rounded-full btn-primary shadow-xl px-5 py-3 hover:scale-105 active:scale-95 transition-transform"
    >
