...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-500 text-white shadow-xl px-5 py-3"
